...
type Monk struct {
	...
	// Set by Mistweaver-line specs (currently only Fistweaver). Tiger Palm
	// damage is doubled via SpellMod and Blackout Kick fans out under
	// Stance of the Wise Serpent. See sim/monk/fistweaver/teachings.go.
	HasTeachings bool
